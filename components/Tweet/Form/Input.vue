    ...
    <div>
        <div class="flex items-center flex-shrink-0 p-4 pb-0">
            ...
            <div class="flex w-12 items-start">
                <img :src="props.user?.profileImage" alt="" class="inline-block size-10 rounded-full">
            </div>

            <div class="w-full p-2">
                <textarea v-model="text"
                    class="w-full h-10 text-base text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dark:text-white focus:ring-0"
